...
<p><?php printf( esc_html__( 'Pagamento por encomenda #%1$s de %2$s falhou. Detalhes do pedido:', 'woocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ); ?></p>
