...
<p><?php echo apply_filters( 'wcmp_thankyou_transaction_received_text', sprintf(__( 'Hello,<br>Recebemos uma nova solicitação de saque de %s de você e sua solicitação está sendo processada. Os detalhes do pedido são os seguintes:', 'dc-woocommerce-multi-vendor'), get_woocommerce_currency().$amount), $transaction_id ); ?></p>
