...
<p><?php esc_html_e( 'Um comentário foi adicionado ao seu pedido:', 'woocommerce' ); ?></p>
...
<p><?php esc_html_e( 'Só pra telembrar, aqui estão os detalhes da sua compra:', 'woocommerce' ); ?></p>
